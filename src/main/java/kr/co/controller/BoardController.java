...
public class BoardController {
	...
	public String read(BoardVO boardVO, @ModelAttribute("scri") SearchCriteria scri, Model model) throws Exception{
		...
		model.addAttribute("read", service.read(boardVO.getBoard_id()));
		model.addAttribute("scri", scri);
		
		List<ReplyVO> replyList=replyService.readReply(boardVO.getBoard_id());
		model.addAttribute("replyList", replyList);
		
		List<Map<String, Object>> fileList=service.selectFileList(boardVO.getBoard_id());
	...
	public String updateView(BoardVO boardVO, @ModelAttribute("scri") SearchCriteria scri, Model model)
		...
		model.addAttribute("update", service.read(boardVO.getBoard_id()));
		model.addAttribute("scri", scri);
	...
	public String delete(BoardVO boardVO) throws Exception{
		...
		service.delete(boardVO.getBoard_id());
